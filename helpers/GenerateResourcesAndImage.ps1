...
Function GenerateResourcesAndImage {
    <#
        ...
        .PARAMETER ManagedImageName
            The name of the managed image to create. 
    ...
    param (
        ...
        [string] $ManagedImageName = "Runner-Image-Windows-2025",
        [Parameter(Mandatory = $True)]
    ...
    # Get template path
    $TemplatePath  = [IO.Path]::Combine($ImageGenerationRepositoryRoot, "images", "windows","templates", "windows-2025.pkr.hcl")
